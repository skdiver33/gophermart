...
import (
	...
	handler "github.com/skdiver33/gophermart/internal/server/handlers"
	mid "github.com/skdiver33/gophermart/internal/server/middleware"
...
func newServerConfig() *ServerConfig {
	...
	serverFlags.StringVar(&serverConfig.AccrualAddress, "r", "http://localhost:8080", "accrual system address")
