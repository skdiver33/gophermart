...
// Source: github.com/skdiver33/gophermart/internal/user (interfaces: UserStorageInterface)
...
func (m *MockUserStorageInterface) AddUser(arg0 context.Context, arg1 *user.User) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserStorageInterface) GetUser(arg0 context.Context, arg1, arg2 string) (*user.User, error) {
	m.ctrl.T.Helper()
